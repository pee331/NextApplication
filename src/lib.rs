// src/lib.rs
/*
 * Core library for NextApplication
 */
...
#[derive(Debug)]
pub struct NextApplicationProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NextApplicationProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NextApplication processing");
    
    let mut processor = NextApplicationProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NextApplicationProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NextApplicationProcessor::new(false);
